...
const PublicQuiz = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <section
        dir={isRTL ? "rtl" : "ltr"}
        className="relative mx-auto w-[92%] max-w-7xl px-4 pb-20 pt-12 sm:pt-16"
      >
{/* Header */}
                                ...
                                className={`
                                  ...
                                  ${
                                    isAdded
                                      ...
                                      : "text-muted-foreground hover:bg-primary/10 hover:text-primary hover:scale-110 active:scale-95 motion-reduce:hover:scale-100 motion-reduce:active:scale-100"
                                  }
                                `}
                                aria-label={
                                  isAdded
